        ...
        <div class="d-flex align-items-center py-1">
                ...
                @if (isset($import['route']) && isset($import['format_file_route']))
                    ...
                    <div class="me-4">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-500px w-md-500px" data-kt-menu="true">
                            ...
                            <!--end::Menu separator-->
                            <!--begin::Form-->
                            <form action="{{ $import['route'] }} " method="post" id='import_data' class="form"
            ...
            @if ($create_modal['btn_permission'] == true)
                @can($create_modal['btn_permission'])
                    @if (isset($create_modal['id']) && isset($create_modal['name']))
                        <!--begin::Add button-->
                        <div class="{{ $create_modal['id'] }}"> <a href="javascript:;"
                            data-bs-toggle="modal" data-bs-target="#{{ $create_modal['id'] }}"
            ...
            @if ($create_modal['btn_permission'] == true)
                @can($create_modal['btn_permission'])
                    @if (isset($create_modal['id']) && isset($create_modal['name']))
                        <!--begin::Add button-->
                        <div class="text-center text-sm-left {{ $create_modal['id'] }}"> <a href="javascript:;"
                                data-toggle="modal" data-target="#{{ $create_modal['id'] }}"
            ...
            @else
                @if ($create_modal['status'] == true)
                    @if (isset($create_modal['id']) && isset($create_modal['name']))
                        <!--begin::Add button-->
                        <div class="text-center text-sm-left {{ $create_modal['id'] }}"> <a
                        ...
                        <button type="button" class="btn btn-primary {{ $create_modal['id'] }}"
                            data-bs-toggle="modal" data-bs-target="#{{ $create_modal['id'] }}">
                            Add New {{ $create_modal['name'] }}
                        </button>
                    @endif
                @endif
            @endif
