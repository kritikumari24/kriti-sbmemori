...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.list', [
            'name' => trans_choice('content.contact_us', 1),
        ]),
        'breadcrumbs' => Breadcrumbs::render('admin.contact-us.index'),
        'filter' => false,
        'create_btn' => [
            'status' => true,
            'route' => route('admin.contact-us.create'),
        ...
        // 'export' => [
        //     'status' => true,
        //     'route' => route('admin.contact-us.getdownload'),
        // ],
    ])
...
@push('scripts')
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var edit_url = `{{ url('/') }}/admin/contact-us/` + row['id'] +
                                `/edit/?tab=edit`;
                            var show_url = `{{ url('/') }}/admin/contact-us/` + row['id'] +
                                `?tab=details`;
        ...
        $(document).on('click', '.clsdelete', function() {
            ...
            var url = `{{ url('/') }}/admin/contact-us/` + id;
