...
@section('admin_filter_form')
    {!! html()->form('POST', route('admin.users.download'))->class('form mb-15')->id('filter_data')->open() !!}
    <!--begin::Card body-->
    <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
            <!--begin::Label-->
            <label class="col-lg-4 col-form-label required fw-bold fs-6">{{ trans_choice('content.email_title', 1) }}</label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
        ...
        <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                {!! html()->text('customer_id', null)->attributes([
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                ...
                {!! html()->select('role', $roles, null)->attributes([
                        'class' => 'form-control form-control-lg form-control-solid',
                        'data-control' => 'select2',
