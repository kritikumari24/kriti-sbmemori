        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto">
                    <span class="navbar-text me-3 d-none d-lg-block">Welcome, {{ $data['user']->name }}</span>
                    <span class="navbar-text d-lg-none mb-2">Welcome, {{ $data['user']->name }}</span>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="card bg-primary text-white h-100">
                                    <div class="card-body text-center d-flex flex-column">
                                        ...
                                        <a href="{{ route('staff.students.index') }}" class="btn btn-light btn-sm mt-auto">View Students</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
