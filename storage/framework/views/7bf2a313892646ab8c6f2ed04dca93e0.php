...
<script src="<?php echo e(asset('admin/dist/plugins/custom/fullcalendar/fullcalendar.bundle.js')); ?>"></script>
<script src="<?php echo e(asset('admin/dist/plugins/custom/datatables/datatables.bundle.js')); ?>"></script>
<!--end::Page Vendors Javascript-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.lazyload/1.9.1/jquery.lazyload.js"></script>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
<script src="<?php echo e(asset('/admin/dist/js/custom/documentation/forms/flatpickr.js')); ?>"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.4/dist/sweetalert2.all.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
<script src="<?php echo e(asset('admin/dist/plugins/custom/fslightbox/fslightbox.bundle.js')); ?>"></script>
...
<script>
    ...
    function isPositiveInteger(str) {
        ...
        if (!isNaN(num)) {
            ...
            let max_digit = `<?php echo e(env('MAX_INT_DIGIT')); ?>`;
    ...
    function actionActiveButton(data, attr, statusclass = "clsstatus") {
        // return parseInt(data) ? "<span class=\"badge badge-success cursor-pointer "+statusclass+" \" "+ attr +" >"+"<?php echo e(trans_choice('content.active_title', 1)); ?>"+"</span>" : "<span class=\"badge badge-danger cursor-pointer  "+statusclass+" \" "+ attr +">"+"Deactivate"+"</span>";
        if (data == 1) {
            return `<div class="badge badge-light-success fw-bolder ${statusclass}" ${attr}><?php echo e(trans_choice('content.active_title', 1)); ?></div>`;
        } else {
            return `<div class="badge badge-light-danger fw-bolder ${statusclass}" ${attr}><?php echo e(trans_choice('content.inactive_title', 1)); ?></div>`;
        }
    }
    ...
    function actionApprovedButton(data, attr, statusclass = "clsstatus") {
        // return parseInt(data) ? "<span class=\"badge badge-success cursor-pointer "+statusclass+" \" "+ attr +" >"+"<?php echo e(trans_choice('content.active_title', 1)); ?>"+"</span>" : "<span class=\"badge badge-danger cursor-pointer  "+statusclass+" \" "+ attr +">"+"Deactivate"+"</span>";
        if (data == 1) {
            return `<div class="badge badge-primary fw-bolder ${statusclass}" ${attr}><?php echo e(trans_choice('content.approved_title', 1)); ?></div>`;
        } else if (data == 0) {
            return `<div class="badge badge-secondary fw-bolder ${statusclass}" ${attr}><?php echo e(trans_choice('content.pending_title', 1)); ?></div>`;
        } else {
            return `<div class="badge badge-danger fw-bolder ${statusclass}" ${attr}><?php echo e(trans_choice('content.rejected_title', 1)); ?></div>`;
        }
    }
    ...
    function deleteImage(url, elem) {
        Swal.fire({
            title: "<?php echo e(__('messages.title_alert_message')); ?>",
            text: "<?php echo e(__('messages.delete_alert_message')); ?>",
            type: 'info',
    ...
    function userImageNameButton(url, name = 'Guest', email = '', img_url = '') {
        if (img_url == '' || img_url == null) {
            var img_url = '<?php echo e(asset('admin/dist/media/avatars/150-26.jpg')); ?>';
        }
        return `<!--begin:: Avatar -->
    ...
    function toggleFilterDrawerManually() {
        var drawerElement = document.querySelector("#kt_drawer_filter");
    ...
    function actionShowWithModal(attr, statusclass = "clsShowModal") {
        ...
        return `<a title="Show" class="btn btn-icon btn-bg-light ${statusclass} btn-active-color-primary btn-sm me-1" ${attr}>
                <span class="svg-icon svg-icon-3">
                  <i class="bi bi-eye fs-2"></i>
                </span>
            </a>`;
    ...
    function actionEditWithModal(attr, statusclass = "clsEditModal") {
        ...
        return `<a title="Edit" class="btn btn-icon btn-bg-light ${statusclass} btn-active-color-primary btn-sm me-1" ${attr} >
                    <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <path d="M12.2674799,18.2323597 L12.0084872,5.45852451 C12.0004303,5.06114792 12.1504154,4.6768183 12.4255037,4.38993949 L15.0030167,1.70195304 L17.5910752,4.40093695 C17.8599071,4.6812911 18.0095067,5.05499603 18.0083938,5.44341307 L17.9718262,18.2062508 C17.9694575,19.0329966 17.2985816,19.701953 16.4718324,19.701953 L13.7671717,19.701953 C12.9505952,19.701953 12.2840328,19.0487684 12.2674799,18.2323597 Z" fill="#000000" fill-rule="nonzero" transform="translate(14.701953, 10.701953) rotate(-135.000000) translate(-14.701953, -10.701953)" />
                            <path d="M12.9,2 C13.4522847,2 13.9,2.44771525 13.9,3 C13.9,3.55228475 13.4522847,4 12.9,4 L6,4 C4.8954305,4 4,4.8954305 4,6 L4,18 C4,19.1045695 4.8954305,20 6,20 L18,20 C19.1045695,20 20,19.1045695 20,18 L20,13 C20,12.4477153 20.4477153,12 21,12 C21.5522847,12 22,12.4477153 22,13 L22,18 C22,20.209139 20.209139,22 18,22 L6,22 C3.790861,22 2,20.209139 2,18 L2,6 C2,3.790861 3.790861,2 6,2 L12.9,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3" />
    ...
    function customFnErrors(form, element_errors) {
        ...
        $.each(element_errors, function(key, element_error) {
            ...
            if (key.indexOf(".") != -1) {
                ...
                selector = selector + "']";
                form.find(selector).closest('.col-md-6.fv-row').append(html);
            } else {
                if (form.find('[name="' + key + '"]').length) {
                    form.find('[name="' + key + '"]').closest(' .col-md-6.fv-row').append(html);
...
<!--end::Javascript-->
<?php /**PATH D:\Herd\sbmemori\resources\views/admin/layouts/core-js.blade.php ENDPATH**/ ?>