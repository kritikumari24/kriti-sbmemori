    ...
    <div id="kt_drawer_filter" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true"
        ...
        <div class="card w-100 rounded-0">
            ...
            <div class=" card-header pe-5" id="kt_drawer_filter_header">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <span
                            class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1"><?php echo e(trans_choice('content.filter_options', 1)); ?></span>
                    </div>
                    <!--end::User-->
                </div>
                <!--end::Title-->
            ...
            <div class="card-body" id="kt_drawer_filter_body">
                <?php echo $__env->yieldContent('admin_filter_form'); ?>
            </div>
            <!--end::Card body-->
            <!--begin::Card footer-->
    ...
    <!--end::View component-->
<?php /**PATH D:\Herd\sbmemori\resources\views/admin/layouts/components/filter_drawer.blade.php ENDPATH**/ ?>